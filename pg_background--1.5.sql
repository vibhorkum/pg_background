...
-- -------------------------------------------------------------------------
-- Privilege helpers (include v2 + hardened search_path)
-- -------------------------------------------------------------------------
...
BEGIN
    ...
    IF print_commands THEN
      RAISE INFO 'Granted pg_background privileges to %', user_name;
    END IF;
...
BEGIN
    ...
    IF print_commands THEN
      RAISE INFO 'Revoked pg_background privileges from %', user_name;
    END IF;
...
-- -------------------------------------------------------------------------
-- Public lockdown (include v2 + type)
-- -------------------------------------------------------------------------
